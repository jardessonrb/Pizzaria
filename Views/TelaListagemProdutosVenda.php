				...
				<div id="mostrapedidos">
					<table border="1" class="" id="tabeladepedidos">
						...
						<tr id="corpo_tabela">
							...
							<td>
						    <span  data-toggle="modal" data-target="#abremodalUpdateProduto" class="btn btn-primary btn-xs" onclick="obterDadosProdutoVenda('<?php echo $mostrar[0] ?>')">
...
<script type="text/javascript">
		function obterDadosProdutoVenda(idproduto){
			$.ajax({
				type:"POST",
